...
Namespace Series_RadarLineChart
    Partial Public Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            CType(RadarLineChart.Diagram, RadarDiagram).RotationDirection = RadarDiagramRotationDirection.Counterclockwise

            ' Add a title to the chart and hide the legend.
            Dim chartTitle1 As New ChartTitle()
            chartTitle1.Text = "Radar Line Chart"
            RadarLineChart.Titles.Add(chartTitle1)
            RadarLineChart.Legend.Visibility = DevExpress.Utils.DefaultBoolean.False
